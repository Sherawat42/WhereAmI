...
//            System.out.println(myLocationList.get(i));
//            System.out.println(myLocationList.get(i).getName());
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_location) {
            Intent i = new Intent();
            i.setClass(this,AddLocationActivity.class);
            startActivity(i);
    ...
    public void openAllOnMapActivity(View view) {
        Intent i = new Intent();
        i.setClass(this,ShowAllMapsActivity.class);
        startActivity(i);
    }
}
